...
using vendor::fpsensor::hardware::parts::V1_0::Number;
using vendor::fpsensor::hardware::parts::V1_0::SysfsType;
...
Java_com_fpsensor_motoextras_interfaces_Battery_setChargeSysfs(
...
Java_com_fpsensor_motoextras_interfaces_Battery_getChargeSysfs(
...
extern "C" JNIEXPORT void JNICALL
Java_com_fpsensor_motoextras_interfaces_Battery_setFastCharge(
...
extern "C" JNIEXPORT jint JNICALL
Java_com_fpsensor_motoextras_interfaces_Battery_getFastChargeSysfs(
    JNIEnv /*env*/, __unused jclass obj) {
  int ret = service->getBatteryStats(SysfsType::FASTCHARGE);
  return ret;
}
extern "C" JNIEXPORT jint JNICALL
Java_com_fpsensor_motoextras_interfaces_Battery_getGeneralBatteryStats(
